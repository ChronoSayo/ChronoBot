...
namespace ChronoBot.Tests.SocialMedias
{
    public class SocialMediaTests
    {
        ...
        {
            var result = _socialMedia.ListSavedSocialMediaUsers(123456789).GetAwaiter().GetResult();
            Assert.Equal(string.Empty, result);
        }
        ...
        public void DeleteSocialMediaUsers_Test_Success()
        {
            ...
            string result = socialMedia.DeleteSocialMediaUser(123456789, "Test1");
        ...
        {
            var result = _socialMedia.DeleteSocialMediaUser(123456789, "Fail");
